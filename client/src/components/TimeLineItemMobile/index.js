  ...
  return (
    <div className="tl-content-wrapper tl-mobile-item-container container">
      <div className="tl-mobile-left">
        ...
        {item.position && (
          <div className="tl-content-position-wrapper tl-mobile-position-wrapper">
        ...
        {item.location && (
          <div className="tl-content-location-wrapper tl-mobile-location-wrapper">
      ...
      <div className="tl-mobile-right">
        <div className="tl-content-description">
          <ul className=" defaultUL tl-content-description-list tl-mobile-description-list">
            {item.description &&
