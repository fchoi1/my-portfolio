  ...
  return (
    <div style={{ height: '100vh' }}>
      ...
      <div className="about-name-wrapper">
        <h1 className="about-name">Fabio Choi</h1>
      </div>
      <Grid
        container
        spacing={{ xs: 0, sm: 3 }}
        ...
        <Grid item sx={{ display: 'flex', justifyContent: 'center' }}>
          <div className="about-content-wrapper">
            <p className="about-content">
              ...
              principles and agile methodology. Seeking new opportunities to use
              strong problem solving, design and adaptability skills in software
              & web development. Fluent in JavaScript, HTML, CSS with strong
